                    ...
                    <section>
                        <header>
                            ...
                            <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
                                {{ __("Update employee details below.") }}
                            </p>
                        </header>
                        ...
                        <form method="post" action="{{ route('employees.update', $employee->id) }}" class="mt-6 space-y-6">
                            ...
                            <div>
                                ...
                                <x-text-input id="first_name" name="first_name" type="text" class="mt-1 block w-full" required value="{{ old('first_name', $employee->first_name) }}" />
                            ...
                            <div>
                                ...
                                <x-text-input id="last_name" name="last_name" type="text" class="mt-1 block w-full" required value="{{ old('last_name', $employee->last_name) }}" />
